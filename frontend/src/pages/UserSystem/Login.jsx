        ...
        {!isRegisterMode && activeTab === 'wechat' && (
          <div style={styles.qrSection}>
            <div style={styles.qrContainer}>
              {qrLoading ? (
                <div style={styles.qrLoading}>
                  <Spin size="large" />
                  <div style={{ marginTop: 12, color: '#999' }}>正在生成二维码...</div>
                </div>
              ) : qrExpired ? (
            ...
            <div style={styles.qrTips}>
              <WechatOutlined style={{ fontSize: 20, color: '#07c160', marginRight: 8 }} />
              使用微信扫一扫登录
            </div>
        ...
        {!isRegisterMode && <div style={styles.otherMethods}>
          {activeTab === 'wechat' ? (
            ...
            <div 
              ...
              onClick={() => setActiveTab('wechat')}
            >
              <div style={{...styles.otherMethodIcon, background: '#f6ffed'}}>
