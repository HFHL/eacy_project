 ...
 * 文档图片高亮组件 - 仅展示溯源区域
 * 
 * 重要：bbox 坐标是 0-1000 范围的归一化坐标，不是像素坐标！
 * 需要根据图片实际尺寸进行换算：
 *   pixelX = bboxX * imageWidth / 1000
 *   pixelY = bboxY * imageHeight / 1000
 * 
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ 
                ...
                {latestHistory.new_value && (
                  <div style={{ marginTop: 8, padding: 8, background: '#e6fffb', borderRadius: 4 }}>
